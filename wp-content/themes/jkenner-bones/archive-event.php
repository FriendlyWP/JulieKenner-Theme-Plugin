				...
				<header class="entry-header">
					...
					<?php
						//if (has_post_thumbnail( )) {
							?>
							<!-- <h1 class="entry-title"><a class="title with-thumb" href="<?php the_permalink(); ?>"><?php the_title();?></a></h1>
							<a class="title-thumb" href="<?php the_permalink(); ?>">
								<?php //If it has one, display the thumbnail
						the_post_thumbnail('thumbnail', array('style'=>''));
						?>
							</a> -->
						<?php// } else { ?>
