			<footer class="footer" role="contentinfo">
				...
				<div id="inner-footer" class="wrap cf">
					...
					<?php if (function_exists('get_field') && get_field('copyrighted', 'option')) {
						?>
						<p class="source-org copyright">&copy; <?php echo date('Y'); ?> <span><?php the_field('copyrighted', 'option' ); ?></span> | <a href="<?php echo wp_login_url(); ?>">Log in</a></p>
						<?php
					} else { ?> 
						<p class="source-org copyright">&copy; <?php echo date('Y'); ?> <?php bloginfo( 'name' ); ?> | <a href="<?php echo wp_login_url(); ?>">Log in</a></p>
					<?php } ?>
