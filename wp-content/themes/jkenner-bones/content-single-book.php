...
<section class="entry-content cf" itemprop="articleBody">
	...
	if (function_exists('get_field')) {
		echo '<div class="book-section">';
			...
			echo do_shortcode('[showbook id="' . get_the_id() . '" class="fullimage alignleft" showcaption="false" ][/showbook]');
			...
			if ( get_field('book_trailer') || get_field('book_trailer') || get_field('excerpt') || get_field('book_trailer') ) {
