<ul>
    <?php // AMAZON 
    if ($mm_isbn) { ?>
    <li><a title="Buy <?php echo $booktitle; ?> at Amazon" target="_blank" href="http://www.amazon.com/gp/search?keywords=<?php echo $mm_isbn;?>&index=books&linkCode=qs&tag=michellewebcom"><img src="<?php echo $imgpath; ?>amazon.png" /></a></li>
    <?php } // end AMAZON ?>

    <?php // KINDLE
    if (get_post_meta($post->ID, "asin", true)) {
        $mm_asin = get_post_meta($post->ID, "asin", true); ?>
        <li><a title="Buy <?php echo $booktitle; ?> for the Kindle" target="_blank" href="http://www.amazon.com/dp/<?php echo $mm_asin;?>/&tag=michellewebcom"><img src="<?php echo $imgpath; ?>kindle.jpg" /></a></li>
    <?php } //end KINDLE ?>
