				...
				$output .= '<div class="cf buyblock">';
					...
					$output .= '<ul>';
						...
						if ( $outObject->isbn_13 && $outObject->parentFormat == 'Print' ) {
							...
							// Amazon
							$output .= '<li><a target="_blank" href="http://www.amazon.com/gp/search?keywords=' .  $outObject->isbn_13 . '&index=books&linkCode=qs&tag=michellewebcom">Amazon</a></li>';
							// AMAZON UK
							$output .= '<li><a target="_blank" href="http://www.amazon.co.uk/gp/search?keywords=' .  $outObject->isbn_13 . '&index=books&linkCode=qs&tag=michellewebcom">Amazon UK</a></li>';
							// Barnes & Noble
						...
						if ( $outObject->asin && $outObject->parentFormat == 'Digital' ) {
							...
							// Amazon Kindle
							$output .= '<li><a target="_blank" href="http://www.amazon.com/gp/search?keywords=' . $outObject->asin . '&linkCode=qs&tag=michellewebcom">Amazon</a></li>';
						}
